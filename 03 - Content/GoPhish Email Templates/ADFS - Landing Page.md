		...
		<tr class="login_panel_layout_row" style="height: 100%;">
			...
			<td id="login_panel_center"><!--office365 logo--><script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            Constants.DEFAULT_LOGO = '{{LOGO_URL}}';
                            Constants.DEFAULT_LOGO_ALT = 'Sign in';
                            Constants.DEFAULT_ILLUSTRATION = 'https://49ryzz358h4t3omd9bq52wv6-wpengine.netdna-ssl.com/wp-content/uploads/sites/10/2020/08/Screen-Shot-2020-05-14-at-2.34.13-PM-aspect-ratio-5-3-1.png';
                            Constants.DEFAULT_BACKGROUND_COLOR = '#FFFFFF';
			...
			<ul class="login_cred_container">
				...
				<span class="input_field textfield"><input class="login_textfield textfield required email field normaltext" name="UsernameForm" placeholder="username@company.com" tabindex="1" type="text"/><br/>
				<br/>
