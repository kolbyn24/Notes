...
- [ ] GoPhish campaign configuration
                ...
                - Evade signature-based phishing detections (google safe browsing) [article](https://www.r-tec.net/r-tec-blog-evade-signature-based-phishing-detections.html) custom [[html obfuscator]] can be used. or this one from the Internet can be used: [public html obfuscator](https://github.com/BinBashBanana/html-obfuscator)
- [ ] Phishing Payloads
